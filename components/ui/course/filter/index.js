...
export default function CourseFilter() {
  return (
    <div className="flex flex-col sm:flex-row items-center my-4">
      <div className="flex mr-2 relative rounded-md mb-3 sm:mb-0">
        <input
          type="text"
          name="account"
          id="account"
          className="w-52 md:w-70 focus:ring-indigo-500 shadow-md focus:border-indigo-500 block pl-7 p-4 sm:text-sm border-gray-300 rounded-md"
